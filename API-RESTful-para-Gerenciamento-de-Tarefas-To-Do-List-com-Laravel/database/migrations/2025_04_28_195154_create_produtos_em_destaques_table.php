...
return new class extends Migration
{
    ...
    {
        Schema::create('produtos_em_destaque', function (Blueprint $table) {
            $table->id();
            $table->foreignId('loja_id')->constrained('lojas')->onDelete('cascade');
            $table->foreignId('template_id')->constrained('templates')->onDelete('cascade');
            $table->string('titulo')->default('Destaques'); // Título da seção
    ...
    {
        Schema::dropIfExists('produtos_em_destaque');
    }
};
