...
return new class extends Migration
{
    ...
    {
        Schema::create('banners_novidades', function (Blueprint $table) {
            $table->id();
            $table->foreignId('loja_id')->constrained('lojas')->onDelete('cascade');
            $table->foreignId('template_id')->constrained('templates')->onDelete('cascade');
            $table->foreignId('produto_id')->constrained('produtos')->onDelete('cascade');
            $table->string('titulo')->nullable(); // Título para os banners de novidades
            ...
            $table->integer('banners_por_linha')->default(1); // Disposição: 1 banner por linha
    ...
    {
        Schema::dropIfExists('banners_novidades');
    }
};
